...
const TIPOS_DOCUMENTO_PROFESIONAL = [
  { value: 'DNI (Frente y Dorso)', label: 'DNI (Frente y Dorso)' },
  { value: 'Antecedentes Penales', label: 'Antecedentes Penales' },
  { value: 'Examen Médico (Preocupacional)', label: 'Examen Médico (Preocupacional)' },
  { value: 'Licencia de Conducir', label: 'Licencia de Conducir' },
  { value: 'Título/Matrícula', label: 'Título/Matrícula' },
  { value: 'Curriculum Vitae', label: 'Curriculum Vitae (PDF)' },
...
export function DocumentsProfesionalPage() {
  ...
  const [tipoDocumento, setTipoDocumento] = useState(TIPOS_DOCUMENTO_PROFESIONAL[0].value);
          ...
          <form onSubmit={handleUpload} className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1">
                ...
                >
                  {TIPOS_DOCUMENTO_PROFESIONAL.map((t) => (
